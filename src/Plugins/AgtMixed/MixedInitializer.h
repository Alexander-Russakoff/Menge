...
/*!
 @file		MixedInitializer.h
 @brief		The AgentInitializer for the mixed Orca/Johansson simulator.
 */
#ifndef __MIXED_INITIALIZER_H__
#define __MIXED_INITIALIZER_H__
...
class AgentInitializer : public Menge::Agents::AgentInitializer {
 ...
 protected:
  /*!
   ...
   which derived classes will also benefit from the `<Johansson>` parameter set.
 ...
 */
  ...
  /*!
   * @brief  Lets try this //TODO
   */
  Menge::Math::FloatGenerator* _orcaAgent;
  /*!
