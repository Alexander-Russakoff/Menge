...
#ifndef __MIXED_SIMULATOR_H__
#define __MIXED_SIMULATOR_H__

/*!
 @file       MixedSimulator.h
...
class Simulator : public Menge::Agents::SimulatorBase<Agent> {
 public:
  ...
  /*!
   ...
   @returns		By default, the simulator base ONLY uses common parameters. Always returns false.
   */
  virtual bool isExpTarget(const std::string& tagName) { return tagName == "Mixed"; }
 ...
 protected:
  ...
  //TODO - Add orca agent bool
  /*!
   * @brief             Whether to use orca instad of Johansson
   */
   static float ORCA_AGENT;
};
}  // namespace Mixed

#endif  // __MIXED_SIMULATOR_H__
