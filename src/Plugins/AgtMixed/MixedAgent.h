...
/*!
 @file		MixedAgent.h
 @brief		Definition of Mixed Orca/Johansson 2007 agent.
 */

#ifndef __MIXED_AGENT_H__
#define __MIXED_AGENT_H__

#include "MengeCore/Agents/BaseAgent.h"
#include "MengeCore/Math/Line.h" //for orca

#include <vector> //for orca
...
class Agent : public Menge::Agents::BaseAgent {
 public:
  ...
  /*!
   * @brief     calls johansson velocity modifier
   */
  void mixed_jo();
  /*!
   * @brif      calls orca velocity modifier
   */
  void mixed_orca();
  ...
  //TODO - lets add orca public function declarations here
